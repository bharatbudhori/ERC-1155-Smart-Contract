...
contract Web3Buildes is ERC1155, Ownable, Pausable, ERC1155Supply, PaymentSplitter {
    ...
    function allowListMint(uint256 id, uint256 amount) public payable {
        ...
        require(msg.value == amount * allowListPrice, "WRONG! Not enough money sent");
        mint(id, amount);
    }
        ...
        payable 
    {
        ...
        require(msg.value == amount * publicPrice, "WRONG! Not enough money sent");
        mint(id, amount);
    }
    ...
    function mint(uint256 id, uint256 amount) internal {
        ...
        require(id < 2, "Sorry looks like you are trying to mint invalid NFT");
